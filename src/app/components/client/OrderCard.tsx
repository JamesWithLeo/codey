...
export default function OrderCard({
  ...
  return (
    <Link href={`/orders/${order.id}`} className="block h-full">
      <Card className="group h-full overflow-hidden rounded-xl border border-border/60 bg-background/95 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-lg">
        <div
          className={
            viewMode === "list"
        ...
        >
          <div
            className={
              viewMode === "list"
                ? "flex min-h-36 items-center justify-center bg-linear-to-br from-zinc-100 via-zinc-50 to-zinc-200 p-6 md:w-40"
                : "flex min-h-36 items-center justify-center bg-linear-to-br from-zinc-100 via-zinc-50 to-zinc-200 p-6"
            }
          >
            <div className="flex h-14 w-14 items-center justify-center rounded-full border border-zinc-200 bg-white/80 text-zinc-700 shadow-sm">
          ...
          <CardHeader className="flex-1 ">
            <div className="flex  justify-center h-full w-full flex-col gap-2 md:flex-row md:items-start md:justify-between">
              ...
              <CardAction className="self-start mt-3">
                <Badge
